...
{{-- Like button --}}
<form action="/reviews/like/{{$review->id}}" method="POST" class="inline-block tooltip">
   @csrf
...
{{-- Dislike button --}}
<form action="/reviews/like/{{$review->id}}" method="POST" class="tooltip inline-block ml-2">
   @csrf
