    ...
    <div class="w-48 tooltip pb-2">
       <div class="">
        ...
        <a class="self-center" href="/books/{{$books[$rand_book]['id']}}"><img
            ...
            alt=""/></a>
            <span class="tooltiptext">Title:<br><b>{{$books[$rand_book]->title}}</b> <br> Author:<br><b>{{$books[$rand_book]->authors[0]['firsn_name']}} {{$books[$rand_book]->authors[0]['last_name']}}</b> </span>
          {{-- {{dd($book->authors)}} --}}
       </div>
       <div class="w-36">
